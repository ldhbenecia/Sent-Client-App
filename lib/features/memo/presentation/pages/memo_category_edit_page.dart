...
import '../../../todo/domain/models/todo_category.dart' show kCategoryIcons;
import '../../../todo/presentation/widgets/category_pickers.dart';
import '../../domain/models/memo_category.dart';

class MemoCategoryEditPage extends ConsumerStatefulWidget {
  const MemoCategoryEditPage({super.key, required this.category});

  final MemoCategory? category; // null = 생성 모드

  @override
  ConsumerState<MemoCategoryEditPage> createState() =>
      _MemoCategoryEditPageState();
}

class _MemoCategoryEditPageState extends ConsumerState<MemoCategoryEditPage> {
  ...
  Future<void> _save() async {
    ...
    try {
      final notifier = ref.read(memoCategoriesProvider.notifier);
      if (_isEdit) {
        await notifier.edit(
